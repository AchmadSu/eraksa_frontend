                                        ...
                                        <form class="form needs-validation" id="app" @submit.prevent="updateFunction" novalidate>
                                            <div class="py-lg-4 py-md-0 py-sm-1">
                                                ...
                                                <div v-if="isLoadingResponse == false">
                                                    <button type="submit" class="btn btn-primary" :style="this.windowWidth <= $widthLandscapePhone ? 'width:100%;':'width:50%;'" :disabled="!submitEnabled"><i class="fa fa-paper-plane"></i> Update Permintaan</button>
                                                </div>
                ...
                try {
                    ...
                    .then((response) => {
                        ...
                        this.detailObject = {
                            ...
                            "date": response.data.data.loans.date,
                            "due_date": response.data.data.loans.due_date,
