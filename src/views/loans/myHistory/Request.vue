            ...
            <div class="modal-dialog modal-dialog modal-dialog-centered">
                <div v-if="successDelete == false" class="modal-content">
                    ...
                    <div class="modal-body text-dark">
                        Apakah anda yakin akan menghapus <b>{{ item.code }}</b>?
                                                ...
                                                <table class="table table-hover table-bordered border" id="dataTable" width="100%" cellspacing="0">
                                                    <thead>
                                                        <tr class="text-center">
                                                            ...
                                                            <th colspan="3" class="align-middle">Aksi</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr v-for="item, index in this.dataArray" :key="item.id">
                                                            ...
                                                            <td class="align-middle text-center" v-if="item.status == '0'"><b class="text-secondary">Menunggu Konfirmasi</b></td>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <button @click="updateFunction(item.id)" :disabled="buttonDisabled" class="btn w-100 btn-success">
                                                                    <i class="fa fa-pencil"></i> <br> Ubah Permintaan
                                                                </button>
                                                            </td>
                                                            <td class="align-middle text-center">
                                                ...
                                                <div v-for="item in this.dataArray" :key="item.id" class="col-sm-6 my-3">
                                                    <div class="card w-100 h-100 btn text-dark text-justify shadow-lg border-bottom-info p-3">
                                                        ...
                                                        <div class="my-2">
                                                            ...
                                                            <p>
                                                                <big v-if="item.status == '0'">Status: <b class="text-secondary">Menunggu Konfirmasi</b></big><br>
            ...
            backFunction(){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        // console.log("Test");
                        setTimeout(() => {
                            this.$router.push({ name: 'myLoans.request' }).then(() => { this.$router.go() })
                        }, 3000);
                    }
                } catch(e) {
                    this.errorResponse = [
            ...
            searchFunction(){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        setTimeout(() => {
                            this.$router.push({ name: 'myLoans.request', 
                                query: {
