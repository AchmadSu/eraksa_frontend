                            ...
                            <div :class="this.windowWidth >= this.$widthLandscapePhone ? 'col-6 pb-3':'col-12 pb-3'">
                                <form class="w-100 d-sm-inline-block form-inline my-2 my-md-0 navbar-search" @submit.prevent="searchFunction">
                                    <div class="input-group">
                                        <input type="text" v-model="form.search" name="search" class="form-control input-lg bg-light" placeholder="Cari Kategori"
            ...
            searchFunction(){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        // console.log("Test");
                        setTimeout(() => {
                            this.$router.push({ name: 'menu.categories', query: {search: this.searchParams} }).then(() => { this.$router.go() })
                        }, 4000);
                    }
                } catch(e) {
                    this.errorResponse = [
            ...
            backFunction(){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        // console.log("Test");
                        setTimeout(() => {
                            this.$router.push({ name: 'menu.categories' }).then(() => { this.$router.go() })
                        }, 3000);
                    }
                } catch(e) {
                    this.errorResponse = [
