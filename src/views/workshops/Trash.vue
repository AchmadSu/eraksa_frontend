            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div :class="this.windowWidth >= this.$widthPotraitPhone ? 'container-fluid':'container-fluid my-5 py-5'">
                        <h1 class="h3 mb-5 text-center text-gray-800">Kelola Data Sampah <br> Bengkel</h1>
    ...
    export default{
        ...
        methods: {
            ...
            searchFunction(){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        // console.log("Test");
                        setTimeout(() => {
                            this.$router.push({ name: 'manageWorkshops.trash', query: {search: this.searchParams} }).then(() => { this.$router.go() })
                        }, 4000);
                    }
                } catch(e) {
                    this.errorResponse = [
            ...
            async restore(id){
                ...
                try {
                    await axios.put('/workshops/restore', this.dataObject)
                    .then((response) => {
                            ...
                            this.dataArray.push(
                                {
                                    ...
                                    "phone": response.data.data.workshops[item].phone
                                }
                            );
                        });
