                                                ...
                                                <div class="py-lg-4 py-md-0 py-sm-1">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input 
                                                            ...
                                                            placeholder="Nama Bengkel" aria-label="name" 
                                                    ...
                                                    <div class="input-group mb-3" tabindex="-1" id="inner">
                                                        <span class="input-group-text bg-transparent" id="basic-addon1">
                                                            <i class="text-secondary fa fa-phone" aria-hidden="true"></i>
                                                        </span>
                                                        <div class="form-floating">
                                                            <input 
                                                                name="phone" type="number" :class="this.checkPhone == false ? 'form-control is-invalid' : 'form-control is-valid'"
                                                                placeholder="Contoh: 6289 XXX (Dapat dikosongkan)" aria-label="Phone" 
                                                                aria-describedby="basic-addon1"
                                                                v-model="form.phone"
                                                                required
                                                            />
                                                            ...
                                                            <label v-else-if="windowWidth <= $widthComputer && windowWidth >= $widthLandscapePhone" for="floatingInputValue">
                                                                <p v-if="this.floatingTextPhone == true">
                                                                    <small>No. Telp. (Dapat dikosongkan)</small>
                                                                </p>
                                                                <p v-else-if="this.checkPhone == false">
        ...
        methods: {
            ...
            async detailFunction(id){
                try {
                    ...
                    await axios.get('/workshops/detail/'+data)
                    .then((response) => {
            ...
            async updateFunction(){
                ...
                this.dataObject = {
                    ...
                    "new_phone": this.form.phone,
                }
                // console.log(this.dataObject);
                try {
                    await axios.put('/workshops/update', this.dataObject)
                    .then((response) => {
                        // this.showAlert = true;
                        this.isLoadingResponse = false;
