            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div :class="this.windowWidth >= this.$widthPotraitPhone ? 'container-fluid':'container-fluid my-5 py-5'">
                        <h1 class="h3 mb-5 text-center text-gray-800">Kelola Data <br> Bengkel</h1>
                                            ...
                                            <div :class="this.windowWidth >= this.$widthLandscapePhone ? 'col-6 pb-3':'col-12 pb-3'">
                                                <form class="w-100 d-sm-inline-block form-inline my-2 my-md-0 navbar-search">
                                                    <div class="input-group">
                                                        <input type="text" v-model="form.search" name="search" class="form-control input-lg bg-light" placeholder="Cari Nama atau Telepon"
    ...
    export default{
        ...
        methods: {
            ...
            trashRouter(){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        // console.log("Test");
                        setTimeout(() => {
                            this.$router.push({ name: 'manageWorkshops.trash' }).then(() => { this.$router.go() })
                        }, 4000);
                    }
                } catch(e) {
                    this.errorResponse = [
            ...
            createRouter(){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        // console.log("Test");
                        setTimeout(() => {
                            this.$router.push({ name: 'manageWorkshops.create' }).then(() => { this.$router.go() })
                        }, 4000);
                    }
                } catch(e) {
                    this.errorResponse = [
            ...
            updateRouter(id){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        // console.log("Test");
                        setTimeout(() => {
                            this.$router.push({ name: 'manageWorkshops.update', query: {data: data} }).then(() => { this.$router.go() })
                        }, 4000);
                    }
                } catch(e) {
                    this.errorResponse = [
            ...
            searchFunction(){
                ...
                try{
                    if(this.setProgress == true) {
                        ...
                        // console.log("Test");
                        setTimeout(() => {
                            this.$router.push({ name: 'manageWorkshops', query: {search: this.searchParams} }).then(() => { this.$router.go() })
                        }, 4000);
                    }
                } catch(e) {
                    this.errorResponse = [
            ...
            async delete(id){
                ...
                try {
                    await axios.delete('/workshops/delete', {params: this.dataObject})
                    .then((response) => {
            ...
            async getWorkshops(skip, take){
                ...
                try {
                    await axios.get('/workshops/getAll', {params: this.dataObject})
                    .then((response) => {
                        // console.log(response.data.data);
                        Object.keys(response.data.data.workshops).forEach((item) => {
                            this.dataArray.push(
                                {
                                    "id": response.data.data.workshops[item].id,
                                    "row": this.index++,
                                    "name": response.data.data.workshops[item].name,
                                    "description": response.data.data.workshops[item].phone,
                                }
                            );
                        });
