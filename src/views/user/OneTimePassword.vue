            ...
            <div class="modal-dialog modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-success">
                        ...
                        <button @click="router" :disabled="buttonDisabled" type="button" class="btn-close" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button @click="router" type="button" class="mr-4 mr-lg-3 btn btn-success">Tutup</button>
                    </div>
                </div>
            </div>
        </div>    
        ...
        methods: {
            ...
            router(){
                ...
                try {
                    ...
                    setTimeout(() => this.$router.push({ name: 'dashboard' }).then(() => { this.$router.go() }), 4000);
                } catch (e) {
                    this.errorResponse = [
                        {
                            'id': 1,
